...
$(document).ready(function () {
        $('.w3').mousemove(function (e) {
            $('.ww3')
                .show()
                .text('alternate senses')
                .css({ fontFamily:'karla',fontSize:'2em', position: 'absolute', color: '#000', zIndex:'100', zIndex:'100',
...
$(document).ready(function () {
        $('.w5').mousemove(function (e) {
            $('.ww5')
                ...
                .text('barilla')
                .css({ fontFamily:'karla',fontSize:'2em', position: 'absolute', color: '#000', zIndex:'100',
                    left: e.pageX/25, top: e.pageY/2.5
            });
        });
